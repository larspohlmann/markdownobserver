...
@Suite(.serialized)
struct FavoriteWatchedFolderTests {
    // MARK: - Model
    ...
    @Test func insertingUniqueFavoriteAppendsNewEntry() {
        ...
        let result = FavoriteHistory.insertingUniqueFavorite(
            name: "Docs",
            folderURL: folderURL,
            options: .default,
    ...
    @Test func removingFavoriteByIDRemovesCorrectEntry() {
        ...
        let result = FavoriteHistory.removingFavorite(id: id, from: entries)
    ...
    @Test func renamingFavoriteUpdatesName() {
        ...
        let result = FavoriteHistory.renamingFavorite(id: id, newName: "New Name", in: entries)
    ...
    @Test func reorderingPreservesOrderByIDs() {
        ...
        let result = FavoriteHistory.reordering(
            ids: [c.id, a.id, b.id],
            in: [a, b, c]
        )
