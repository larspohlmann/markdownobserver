...
protocol FolderWatchControllerDelegate: AnyObject {
    ...
    func folderWatchController(_ controller: FolderWatchController, handleEvents events: [ReaderFolderWatchChangeEvent], in session: ReaderFolderWatchSession, origin: ReaderOpenOrigin)
